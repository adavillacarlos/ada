        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 gap-4">
            <div className="flex flex-col">
              ...
              <div className="text-gray-300">A mobile application that evaluates a yoga practitioner’s pose accuracy and consistency in real-time and provides a performance history of previous executions.</div>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-4">
            <div className="flex flex-col">
              <div className="font-semibold">InquireNear</div>
              <div className="text-gray-300">A furniture shop that allows you to browse, order, and shop furnitures online.</div>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-4">
            <div className="flex flex-col">
